const YTD_OPTIONS = (() => {
  ...
  const COPY = {
    en: {
      ...
      deepseekHelp:
        "YouTube Digest uses DeepSeek V4 Flash for overviews, explanations, selected-text translation, and note polishing. ",
    ...
    "zh-CN": {
      ...
      deepseekHelp:
        "YouTube Digest 使用 DeepSeek V4 Flash 生成概览、解释内容、翻译选中文字和润色笔记。",
