 ...
 * 4. Translating selected page text into Simplified Chinese
 *
...
// ============================================================
// When the viewer selects text on a YouTube watch page, show a floating
// card and translate that selection into Simplified Chinese.
...
function ensureSelectionTranslator() {
  ...
  root.innerHTML = `
    ...
    <div class="card" role="dialog" aria-label="Chinese translation">
      <div class="header">
        <div class="title">YouTube Digest · 中文</div>
...
function teardownSelectionTranslation() {
  if (selectionTranslationTimer) {
